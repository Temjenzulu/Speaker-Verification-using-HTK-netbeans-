...
public class statements1{
   ...
   public void s1(ActionEvent event) throws IOException   
   {
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement1.fxml"));
      ...
      BufferedReader br = new BufferedReader(new FileReader("/home/zzzz/Desktop/KICHUHTK/test.txt"));
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                      ...
                      AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement2.fxml"));
anchor.getChildren().setAll(pane);
   }
  ...
  public  void s3(ActionEvent event) throws IOException   
   {
     ...
     BufferedReader br = new BufferedReader(new FileReader("/home/zzzz/Desktop/KICHUHTK/test.txt"));
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
             AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement3.fxml"));
anchor.getChildren().setAll(pane);
   }
...
public void s4(ActionEvent event) throws IOException   
   {
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                    AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement4.fxml"));
anchor.getChildren().setAll(pane);
   }
...
public void s5(ActionEvent event) throws IOException   
   {
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                     AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement5.fxml"));
anchor.getChildren().setAll(pane);
   }
...
public void s6(ActionEvent event) throws IOException   
   {
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                  AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement6.fxml"));
anchor.getChildren().setAll(pane);
   }
...
public void s7(ActionEvent event) throws IOException   
   {
     ...
     BufferedReader br = new BufferedReader(new FileReader("/home/zzzz/Desktop/KICHUHTK/test.txt"));
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                   AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement7.fxml"));
anchor.getChildren().setAll(pane);
   }
...
public void s8(ActionEvent event) throws IOException   
 ...
 BufferedReader br = new BufferedReader(new FileReader("/home/zzzz/Desktop/KICHUHTK/test.txt"));
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                    AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement8.fxml"));
anchor.getChildren().setAll(pane);
   }
...
public void s9(ActionEvent event) throws IOException   
   ...
   BufferedReader br = new BufferedReader(new FileReader("/home/zzzz/Desktop/KICHUHTK/test.txt"));
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                   AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement9.fxml"));
anchor.getChildren().setAll(pane);
   }
...
public void s10(ActionEvent event) throws IOException   
 ...
 BufferedReader br = new BufferedReader(new FileReader("/home/zzzz/Desktop/KICHUHTK/test.txt"));
       ...
       PrintWriter writer = new PrintWriter("/home/zzzz/Desktop/KICHUHTK/test.txt");
                ...
                writer.flush();
                     AnchorPane pane=FXMLLoader.load(getClass().getResource("s1statement10.fxml"));
anchor.getChildren().setAll(pane);
   }
